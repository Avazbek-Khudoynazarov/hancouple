    ...
    <div className={styles.container}>
      ...
      <div className={styles.titleSection}>
        <p className={styles.subtitle}>
          한 번의 충전으로 수많은 일상이 시작됩니다. <br />{" "}
          <b>그 시작이 언제나 안전하도록,</b> 안정성과 효율을 동시에 잡으세요.
        </p>
      </div>
      ...
      <div className={styles.bottomSection}>
        <div className={styles.bottomContent}>
          ...
          <p className={styles.bottomDescription}>
            <b>DC 누설 대응형 차단기(Type B RCD)와 환기·스프링클러</b>를 통해
            화재 위험을 최소화하고,
            <b>
              케이블의 <br /> 정기 점검
            </b>
            으로 접촉저항과 열화를 예방합니다. 온도와 전류를 실시간 모니터링하여
            이상 발생 시 즉시
            <br />
            차단되는 안전 충전 환경을 구현하세요.
          </p>
        </div>
      </div>
    </div>
