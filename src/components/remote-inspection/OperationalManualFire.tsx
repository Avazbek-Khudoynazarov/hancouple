      ...
      <div className={styles.content}>
        ...
        <section className={styles.targetSection}>
          ...
          <div className={styles.targetGridFive}>
            ...
            <div className={styles.targetItem}>
              <div className={styles.targetImageContainer}>
                <img src="/assets/remote/metro.png" alt="다중이용시설" />
              </div>
              <h3 className={styles.targetLabel}>다중이용시설</h3>
            </div>
            ...
            <div className={styles.targetItem}>
              <div className={styles.targetImageContainer}>
                <img src="/assets/remote/factoryMan.png" alt="제조업 공장" />
              </div>
              <h3 className={styles.targetLabel}>제조업 공장</h3>
            </div>
          </div>
        </section>
